// src/components/clientes/EditClienteModal.jsx
import React, { useState } from "react";
import ClienteForm from "./ClienteForm";
import { updateCliente } from "../../api/clientes.js";

export default function EditClienteModal({ onClose, refresh, cliente }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4 overflow-auto">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-xl max-h-[90vh] p-6 overflow-auto">
        ...
        <ClienteForm onSubmit={handleSubmit} initialData={cliente} />
      </div>
    </div>
  );
}
