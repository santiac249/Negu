...
export default function SubcategoriaFormModal({ open, onClose, onSubmit, initialData }) {
  const [form, setForm] = useState({ subcategoria: "", descripcion: "" });
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4 overflow-auto">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-xl max-h-[90vh] p-6 overflow-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-800">{isUpdate ? "Editar subcategoría" : "Crear subcategoría"}</h2>
